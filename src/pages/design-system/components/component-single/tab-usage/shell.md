---
title: Shell
permalink: design-system/components/shell/usage/
---
...
![Shell screenshot](images/foundations/shell/shell-basics.svg)
...
![Shell suite screenshot](images/foundations/shell/shell--suite.svg)
_Example: Shell for the Zywave suite._

<Spacer/>

![Shell Modmaster screenshot](images/foundations/shell/shell--individual-mm.svg)
...
![Shell mobile screenshot](images/foundations/shell/shell--mobile-basics.svg)
...
![Topbar - anatomy - suite level](images/foundations/shell/topbar/topbar--anatomy--suite.svg)
...
![Topbar - anatomy - suite level](images/foundations/shell/topbar/topbar--anatomy--singleproduct.svg)
...
![Topbar - anatomy - suite level](images/foundations/shell/topbar/topbar--anatomy--mobile.svg)
...
![Sidenav - suite standard items](images/foundations/shell/sidenav/sidenav-anatomy--desktop-standard-nav-items.svg)
...
![Sidenav - anatomy](images/foundations/shell/sidenav/sidenav-anatomy--desktop-expanded.svg)
...
![Sidenav - anatomy](images/foundations/shell/sidenav/sidenav-anatomy--desktop-expanded-behavior.svg)
...
![Sidenav - anatomy](images/foundations/shell/sidenav/sidenav-anatomy--desktop-collapsed-behavior.svg)
...
![Sidenav - anatomy](images/foundations/shell/sidenav/sidenav-anatomy--mobile-behavior.svg)
...
![Footer - 480](images/foundations/shell/footer/footer--≥480.svg)

#### Breakpoint - ≥`720px`

![Footer - 720](images/foundations/shell/footer/footer--≥720.svg)

#### Breakpoint - ≥`1024px`

![Footer - 1024](images/foundations/shell/footer/footer--≥1024.svg)
...
![Basics of the content area](images/foundations/shell/content-area/content-area_basics.svg)
...
![Card Width Do](images/foundations/shell/content-area/cardwidth_do.svg)
...
![Card Width Don't](images/foundations/shell/content-area/cardwidth_dont.svg)
...
![Page Components Do](images/foundations/shell/content-area/pagecomponent_do.svg)
...
![Page Components Don't](images/foundations/shell/content-area/pagecomponent_dont.svg)
...
![Context switcher anatomy](images/foundations/shell/context-switcher/Anatomy.svg)
...
![Context switcher anatomy collapsed](images/foundations/shell/context-switcher/Anatomy_collapsed.svg)
...
![Mobile context swithcer](images/foundations/shell/context-switcher/Context_switcher_mobile.svg)
...
![Expanded switcher hover](images/foundations/shell/context-switcher/Hover.svg)
</br>
</br>
...
![Collapsed switcher hover](images/foundations/shell/context-switcher/Hover_collapsed.svg)
...
![Best practices for context switcher](images/foundations/shell/context-switcher/Best_practices.svg)
...
![Behavior when collapsing Sidenav with Context switcher](images/foundations/shell/context-switcher/Collapse_sidenav.gif)
...
![in a long form](images/foundations/shell/action-bar/usage-long-form.svg)
...
![in a multi-step form](images/foundations/shell/action-bar/usage-multi-step.svg)
...
![when editing a document](images/foundations/shell/action-bar/usage-editing.svg)
...
![anatomy](images/foundations/shell/action-bar/anatomy.svg)
...
![expanded side nav](images/foundations/shell/action-bar/expandednav.svg)
...
![scrolled focus state](images/foundations/shell/action-bar/scrolled.svg)
...
![responsiveness](images/foundations/shell/action-bar/responsiveness.svg)
...
![keyboard](images/foundations/shell/action-bar/keyboard.svg)
...
![steps](images/foundations/shell/action-bar/steps.svg)
